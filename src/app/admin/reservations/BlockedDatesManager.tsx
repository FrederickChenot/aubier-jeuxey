...
export default function BlockedDatesManager({ blocked }: { blocked: BlockedDate[] }) {
  ...
  return (
    <main className="min-h-screen bg-[#f7f5f0]">
      <header className="bg-[#3a3d42] px-6 py-4">
        <div className="flex items-center gap-4">
          <Link href="/admin" className="text-sm text-[#8aab94] hover:text-[#f7f5f0]">← Dashboard</Link>
          <span className="font-[family-name:var(--font-playfair)] text-lg italic text-[#f7f5f0]">
            Dates bloquées
          </span>
        </div>
      </header>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl border border-[#b8cfc0]/30 overflow-hidden">
          <div className="px-5 py-4 border-b border-[#b8cfc0]/30">
            <p className="font-medium text-[#3a3d42] text-sm">Dates actuellement bloquées</p>
          </div>
          {blocked.length === 0 ? (
